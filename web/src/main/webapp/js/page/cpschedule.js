var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="cpschedule/listpage";
     var updateUrl="cpschedule/update";
     var deleteUrl="cpschedule/delete";
     var addUrl="cpschedule/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	    ...
	    columns:[[
					...
					{field:'areaname',title:'片区',width:100},	
					{field:'worktime',title:'工作时间',width:100},	
					{field:'orgname',title:'联络科室',width:100},
					{field:'leadname',title:'挂包领导',width:100},	
					{field:'officename',title:'联络人',width:100}	
			    ]],
	...
	function destroyContactPointSchedule(){
	...
	function newContactPointSchedule(){
	...
	function editContactPointSchedule(){
		var row = $(datagridId).datagrid('getSelected');
		if (row){
	...
	function saveContactPointSchedule(mydialogueId,myFormId){
		$.ajax({
            url: url,
