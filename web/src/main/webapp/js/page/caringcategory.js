var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="caringcategory/listpage";
     var updateUrl="caringcategory/update";
     var deleteUrl="caringcategory/delete";
     var addUrl="caringcategory/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function destroyCaringCategory(){
	...
	function saveCaringCategory(mydialogueId,myFormId){
		$.ajax({
            url: url,
