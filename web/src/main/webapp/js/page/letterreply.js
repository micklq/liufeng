var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="letterreply/listpage";
     var updateUrl="letterreply/update";
     var deleteUrl="letterreply/delete";
     var addUrl="letterreply/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function newLetterReply(){
		...
		/* $('#addrolelist').combobox({
	        ...
	        multiple:true,
            panelHeight:'auto',
	        url: 'letterreply/letterreplylistAjax'
		}); */
		
	}
	function editLetterReply(){
		var row = $(datagridId).datagrid('getSelected');
		if (row){
	...
	function saveLetterReply(mydialogueId,myFormId){
		$.ajax({
            url: url,
