var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="supervreply/listpage";
     var updateUrl="supervreply/update";
     var deleteUrl="supervreply/delete";
     var addUrl="supervreply/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function newSupervReply(){
		...
		/* $('#addrolelist').combobox({
	        ...
	        multiple:true,
            panelHeight:'auto',
	        url: 'supervreply/supervreplylistAjax'
		}); */
		
	}
	function editSupervReply(){
		var row = $(datagridId).datagrid('getSelected');
		if (row){
	...
	function saveSupervReply(mydialogueId,myFormId){
		$.ajax({
            url: url,
