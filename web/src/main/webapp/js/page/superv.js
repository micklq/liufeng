var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="superv/listpage";
     var updateUrl="superv/update";
     var deleteUrl="superv/delete";
     var addUrl="superv/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function saveSuperv(mydialogueId,myFormId){
		$.ajax({
            url: url,
