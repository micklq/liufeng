var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="village/listpage";
     var updateUrl="village/update";
     var deleteUrl="village/delete";
     var addUrl="village/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	    ...
	    columns:[[
					...
					{field:'countyname',title:'所属区域',width:200},
					{field:'description',title:'详细信息',width:300},
			    ]],
	...
	function saveVillage(mydialogueId,myFormId){
		$.ajax({
            url: url,
