var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="firstnet/listpage";
     var updateUrl="firstnet/update";
     var deleteUrl="firstnet/delete";
     var addUrl="firstnet/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	    ...
	    columns:[[
					...
					{field:'officeName',title:'负责人',width:100}													
			    ]],
	...
	function saveFirstNetwork(mydialogueId,myFormId){
		$.ajax({
            url: url,
