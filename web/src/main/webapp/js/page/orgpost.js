var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="orgpost/listpage";
     var updateUrl="orgpost/update";
     var deleteUrl="orgpost/delete";
     var addUrl="orgpost/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function saveOrgPost(mydialogueId,myFormId){
		$.ajax({
            url: url,
