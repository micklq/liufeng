var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="threenet/listpage";
     var updateUrl="threenet/update";
     var deleteUrl="threenet/delete";
     var addUrl="threenet/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	    ...
	    columns:[[
					...
					{field:'countynames',title:'辐射乡镇',width:100},	
	...
	function saveThreeNetwork(mydialogueId,myFormId){
		$.ajax({
            url: url,
