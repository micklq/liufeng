var datagridId="#tt";
     ...
     var pageSize=50;
     var listUrl="test/listpage";
     var updateUrl="test/update";
     var deleteUrl="test/delete";
     var addUrl="test/create";     
     var url;
	$(function() {
		$(datagridId).datagrid({
				fitColumns:true,
	...
	function saveTest(mydialogueId,myFormId){
		$.ajax({
            url: url,
